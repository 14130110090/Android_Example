package com.example.mnavigationbar;
...
public class MNavigationBar extends LinearLayout {
    ...
    private MNavigationBar.OnTabClickListener onTabClickListener;
    ...
    public MNavigationBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.MNavigationBar);
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
//要放在前面
            textSizeType = attributes.getInt(R.styleable.MNavigationBar_Easy_textSizeType, textSizeType);


            msgPointColor = attributes.getColor(R.styleable.MNavigationBar_Easy_msgPointColor, msgPointColor);
            navigationHeight = attributes.getDimension(R.styleable.MNavigationBar_Easy_navigationHeight, navigationHeight);
            navigationBackground = attributes.getColor(R.styleable.MNavigationBar_Easy_navigationBackground, navigationBackground);

            msgPointMoreWidth = attributes.getDimension(R.styleable.MNavigationBar_Easy_msgPointMoreWidth, msgPointMoreWidth);
            msgPointMoreHeight = attributes.getDimension(R.styleable.MNavigationBar_Easy_msgPointMoreHeight, msgPointMoreHeight);
            msgPointMoreRadius = attributes.getInt(R.styleable.MNavigationBar_Easy_msgPointMoreRadius, msgPointMoreRadius);
            tabTextSize = NavigationUtil.compareTo(getContext(), attributes.getDimension(R.styleable.MNavigationBar_Easy_tabTextSize, 0), tabTextSize, textSizeType);
            tabTextTop = attributes.getDimension(R.styleable.MNavigationBar_Easy_tabTextTop, tabTextTop);
            iconSize = (int) attributes.getDimension(R.styleable.MNavigationBar_Easy_tabIconSize, iconSize);
            hintPointSize = attributes.getDimension(R.styleable.MNavigationBar_Easy_hintPointSize, hintPointSize);
            msgPointSize = attributes.getDimension(R.styleable.MNavigationBar_Easy_msgPointSize, msgPointSize);
            hintPointLeft = attributes.getDimension(R.styleable.MNavigationBar_Easy_hintPointLeft, hintPointLeft);
            msgPointTop = attributes.getDimension(R.styleable.MNavigationBar_Easy_msgPointTop, -iconSize * 3 / 5);
            hintPointTop = attributes.getDimension(R.styleable.MNavigationBar_Easy_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(R.styleable.MNavigationBar_Easy_msgPointLeft, -iconSize / 2);
            msgPointTextSize = NavigationUtil.compareTo(getContext(),attributes.getDimension(R.styleable.MNavigationBar_Easy_msgPointTextSize, 0),msgPointTextSize,textSizeType);
            centerIconSize = attributes.getDimension(R.styleable.MNavigationBar_Easy_centerIconSize, centerIconSize);
            centerLayoutBottomMargin = attributes.getDimension(R.styleable.MNavigationBar_Easy_centerLayoutBottomMargin, centerLayoutBottomMargin);

            //加号属性
            centerSelectTextColor = attributes.getColor(R.styleable.MNavigationBar_Easy_centerSelectTextColor, centerSelectTextColor);
            centerNormalTextColor = attributes.getColor(R.styleable.MNavigationBar_Easy_centerNormalTextColor, centerNormalTextColor);
            centerTextSize = NavigationUtil.compareTo(getContext(), attributes.getDimension(R.styleable.MNavigationBar_Easy_centerTextSize, 0), centerTextSize, textSizeType);
            centerTextTopMargin = attributes.getDimension(R.styleable.MNavigationBar_Easy_centerTextTopMargin, centerTextTopMargin);
            centerAlignBottom = attributes.getBoolean(R.styleable.MNavigationBar_Easy_centerAlignBottom, centerAlignBottom);


            lineHeight = attributes.getDimension(R.styleable.MNavigationBar_Easy_lineHeight, lineHeight);
            lineColor = attributes.getColor(R.styleable.MNavigationBar_Easy_lineColor, lineColor);


            centerLayoutHeight = attributes.getDimension(R.styleable.MNavigationBar_Easy_centerLayoutHeight, navigationHeight + lineHeight);

            normalTextColor = attributes.getColor(R.styleable.MNavigationBar_Easy_tabNormalColor, normalTextColor);
            selectTextColor = attributes.getColor(R.styleable.MNavigationBar_Easy_tabSelectColor, selectTextColor);

            int type = attributes.getInt(R.styleable.MNavigationBar_Easy_scaleType, 0);
            if (type == 0) {
            ...
            centerLayoutRule = attributes.getInt(R.styleable.MNavigationBar_Easy_centerLayoutRule, centerLayoutRule);
            hasPadding = attributes.getBoolean(R.styleable.MNavigationBar_Easy_hasPadding, hasPadding);

            centerAsFragment = attributes.getBoolean(R.styleable.MNavigationBar_Easy_centerAsFragment, centerAsFragment);
            attributes.recycle();
        }
    }


    public MNavigationBar setupWithViewPager(@NonNull ViewPager viewPager) {
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
     ...
     * 重置各个参数
     */
    public MNavigationBar defaultSetting() {
...
//        }
    ...
    public MNavigationBar centerImageRes(int centerImageRes) {
    ...
    public MNavigationBar centerTextStr(String centerTextStr) {
    ...
    public MNavigationBar centerLayoutHeight(int centerLayoutHeight) {
        this.centerLayoutHeight = NavigationUtil.dip2px(getContext(), centerLayoutHeight);
        return this;
    }

    public MNavigationBar scaleType(ImageView.ScaleType scaleType) {
        this.scaleType = scaleType;
        return this;
    }


    public MNavigationBar mode(int mode) {
        this.mode = mode;
        return this;
    }

    public MNavigationBar hasPadding(boolean hasPadding) {
        this.hasPadding = hasPadding;
        return this;
    }

    public MNavigationBar centerIconSize(int centerIconSize) {
        this.centerIconSize = NavigationUtil.dip2px(getContext(), centerIconSize);
        return this;
    }


    public MNavigationBar navigationBackground(int navigationBackground) {
        this.navigationBackground = navigationBackground;
        return this;
    }

    public MNavigationBar navigationHeight(int navigationHeight) {
        this.navigationHeight = NavigationUtil.dip2px(getContext(), navigationHeight);
        return this;
    }

    public MNavigationBar normalTextColor(int normalTextColor) {
        this.normalTextColor = normalTextColor;
        return this;
    }

    public MNavigationBar selectTextColor(int selectTextColor) {
        this.selectTextColor = selectTextColor;
        return this;
    }

    public MNavigationBar lineHeight(int lineHeight) {
        this.lineHeight = lineHeight;
        return this;
    }

    public MNavigationBar lineColor(int lineColor) {
        this.lineColor = lineColor;
        return this;
    }

    public MNavigationBar tabTextSize(int tabTextSize) {
        this.tabTextSize = tabTextSize;
        return this;
    }

    public MNavigationBar tabTextTop(int tabTextTop) {
        this.tabTextTop = NavigationUtil.dip2px(getContext(), tabTextTop);
        return this;
    }

    public MNavigationBar msgPointTextSize(int msgPointTextSize) {
        this.msgPointTextSize = msgPointTextSize;
        return this;
    }

    public MNavigationBar msgPointSize(int msgPointSize) {
        this.msgPointSize = NavigationUtil.dip2px(getContext(), msgPointSize);
        return this;
    }

    public MNavigationBar msgPointLeft(int msgPointLeft) {
        this.msgPointLeft = NavigationUtil.dip2px(getContext(), msgPointLeft);
        return this;
    }

    public MNavigationBar msgPointTop(int msgPointTop) {
        this.msgPointTop = NavigationUtil.dip2px(getContext(), msgPointTop);
        return this;
    }


    public MNavigationBar hintPointSize(int hintPointSize) {
        this.hintPointSize = NavigationUtil.dip2px(getContext(), hintPointSize);
        return this;
    }

    public MNavigationBar hintPointLeft(int hintPointLeft) {
        this.hintPointLeft = NavigationUtil.dip2px(getContext(), hintPointLeft);
        return this;
    }

    public MNavigationBar hintPointTop(int hintPointTop) {
        this.hintPointTop = NavigationUtil.dip2px(getContext(), hintPointTop);
        return this;
    }


    public MNavigationBar titleItems(String[] titleItems) {
        this.titleItems = titleItems;
        return this;
    }

    public MNavigationBar normalIconItems(int[] normalIconItems) {
        this.normalIconItems = normalIconItems;
        return this;
    }

    public MNavigationBar selectIconItems(int[] selectIconItems) {
        this.selectIconItems = selectIconItems;
        return this;
    }

    public MNavigationBar fragmentList(List<Fragment> fragmentList) {
        this.fragmentList = fragmentList;
        return this;
    }

    public MNavigationBar fragmentManager(FragmentManager fragmentManager) {
        this.fragmentManager = fragmentManager;
        return this;
    }

    public MNavigationBar anim(Anim anim) {
        if (anim != null) {
    ...
    public MNavigationBar centerLayoutRule(int centerLayoutRule) {
        this.centerLayoutRule = centerLayoutRule;
        return this;
    }

    public MNavigationBar canScroll(boolean canScroll) {
        this.canScroll = canScroll;
        return this;
    }

    public MNavigationBar smoothScroll(boolean smoothScroll) {
        this.smoothScroll = smoothScroll;
        return this;
    }


    public MNavigationBar setOnTabClickListener(MNavigationBar.OnTabClickListener onTabClickListener) {
        this.onTabClickListener = onTabClickListener;
        return this;
    }

    public MNavigationBar setOnCenterTabClickListener(OnCenterTabSelectListener onCenterTabClickListener) {
        this.onCenterTabClickListener = onCenterTabClickListener;
        return this;
    }

    public MNavigationBar iconSize(int iconSize) {
        this.iconSize = NavigationUtil.dip2px(getContext(), iconSize);
        return this;
    }

    public MNavigationBar centerLayoutBottomMargin(int centerLayoutBottomMargin) {
        this.centerLayoutBottomMargin = NavigationUtil.dip2px(getContext(), centerLayoutBottomMargin);
        return this;
    }

    public MNavigationBar centerAsFragment(boolean centerAsFragment) {
        this.centerAsFragment = centerAsFragment;
        return this;
    }

    public MNavigationBar addCustomView(View customAddView) {
        this.customAddView = customAddView;
        return this;
    }

    public MNavigationBar centerTextSize(int centerTextSize) {
        this.centerTextSize = NavigationUtil.dip2px(getContext(), centerTextSize);
        return this;
    }

    public MNavigationBar centerNormalTextColor(int centerNormalTextColor) {
        this.centerNormalTextColor = centerNormalTextColor;
        return this;
    }

    public MNavigationBar centerSelectTextColor(int centerSelectTextColor) {
        this.centerSelectTextColor = centerSelectTextColor;
        return this;
    }

    public MNavigationBar centerTextTopMargin(int centerTextTopMargin) {
        this.centerTextTopMargin = NavigationUtil.dip2px(getContext(), centerTextTopMargin);
        return this;
    }

    public MNavigationBar centerAlignBottom(boolean centerAlignBottom) {
    ...
    public MNavigationBar.OnTabClickListener getOnTabClickListener() {
    ...
    public MNavigationBar textSizeType(int textSizeType) {
    ...
    public MNavigationBar setMsgPointMoreWidth(float msgPointMoreWidth) {
    ...
    public MNavigationBar setMsgPointMoreHeight(float msgPointMoreHeight) {
    ...
    public MNavigationBar setMsgPointMoreRadius(int msgPointMoreRadius) {
    ...
    public MNavigationBar setMsgPointColor(int msgPointColor) {
        this.msgPointColor = msgPointColor;
        return this;
    }

    public MNavigationBar setOnTabLoadListener(OnTabLoadListener onTabLoadListener) {
